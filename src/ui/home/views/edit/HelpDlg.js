...
const autoCompletes=[
    ['!','生成标记：![图片]()','// 光标在 ! 之后时生效'],
    ['[','生成标记：[链接]()','// 光标在 [ 之后时生效'],
    ['[f','生成标记：[](file:///)','// 光标在 [f 之后时生效'],
    ['|r','提取节点文本并自动补全为：<br/>|ref:mmnn','// 光标在 |r 之后且在行尾时生效'],
    ['|t','提取节点文本并自动补全为：<br/>|tref:qqxx','// 光标在 |t 之后且在行尾时生效'],
    ['ref:xx','跳转到引用位置','// 光标在节点内该段中任意位置时生效'],
    ['tref:yy','跳转到文字引用位置','// 光标在节点内该段中任意位置时生效'],
    ['{d}','生成当天日期','// 光标 { } 之间或 } 右侧时生效'],
    ['{d+2}','生成后天日期','// 光标 { } 之间或 } 右侧时生效'],
    ['{t}','生成当前时间','// 光标 { } 之间或 } 右侧时生效'],
    ['{dt}','生成当前日期和时间','// 光标 { } 之间或 } 右侧时生效'],
    ['{u}','从剪切版取出url链接并生成标记：<br/>[百度](https://baidu.com)','// 光标 { } 之间或 } 右侧时生效'],
    ['{p}','保存剪切板图片到本地并生成标记：<br/>![](assets/xxx.jpg)','// 光标 { } 之间或 } 右侧时生效'],
    ['{a}','保存剪切板附件到本地并生成标记：<br/>[abc.doc](assets/yyy.doc)','// 光标 { } 之间或 } 右侧时生效'],
    ['{p+}','剪切板图片上传到图床并生成标记：<br/>![](http://mmm)','// 光标 { } 之间或 } 右侧时生效'],
    ['{a+}','剪切板附件上传到图床并生成标记：<br/>[abc.doc](http://nnn)','// 光标 { } 之间或 } 右侧时生效'],
];
