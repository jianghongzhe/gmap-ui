...
import { PlusOutlined, FolderOpenOutlined, EditOutlined, FolderOutlined,CodeOutlined,ExpandAltOutlined,ControlOutlined } from '@ant-design/icons';
    ...
    render() {
        return (
            <Header css={headerStyle}>
                ...
                <Button shape='circle' icon={<CodeOutlined />} className='toolbtn' type='primary' size='large' onClick={this.props.onShowCmd}  title='打开git' />
                <Button shape='circle' icon={<ControlOutlined />} className='toolbtn' type='primary' size='large' onClick={this.props.onShowDevTool}  title='开发者工具' />
